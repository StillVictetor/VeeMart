...
const data = {
  new: [
    { id: 1, img: img1, badge: "New", name: "Product Name", price: 56.2, category: "Furniture" },
    { id: 2, img: img2, badge: "Sale", name: "Product Name", price: 36.2, category: "Furniture" },
    { id: 3, img: img3, name: "Name", price: 66.2, category: "Furniture" },
    { id: 4, img: img4, name: "Name", price: 57.2, category: "Furniture" },
  ],
  bestseller: [
    { id: 5, img: img2, badge: "Sale", name: "Top Seller", price: 48.5, category: "Furniture" },
    { id: 6, img: img1, badge: "New", name: "Top Seller", price: 75.0, category: "Furniture" },
    { id: 7, img: img1, name: "Top Seller", price: 75.0, category: "Furniture" },
    { id: 8, img: img1, badge: "New", name: "Top Seller", price: 75.0, category: "Furniture" },
  ],
  mostview: [
    { id: 9, img: img4, name: "Most Viewed", price: 44.5, category: "Furniture" },
    { id: 10, img: img3, name: "Most Viewed", price: 82.9, category: "Furniture" },
    { id: 11, img: img3, name: "Most Viewed", price: 82.9, category: "Furniture" },
    { id: 12, img: img3, name: "Most Viewed", price: 82.9, category: "Furniture" },
  ],
  discounts: [
    { id: 13, img: img2, badge: "Sale", name: "Discount Item", price: 22.5, category: "Furniture" },
    { id: 14, img: img1, badge: "Sale", name: "Discount Item", price: 18.0, category: "Furniture" },
  ],
};
