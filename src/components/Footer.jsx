        ...
        <div className="footer-container">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-contact">
              ...
              <li><span>Cell-Phone :</span>+234 7035731997</li>
              <li><span>Email :</span>veemart@gmail.com</li>
            </ul>
          </div>
      ...
      <div className="copyright-area">
        <div className="copyright-container">
          ...
          <div className="payment">
            <a href="#"><img src={pay1} alt="payment" /></a>
            <a href="#"><img src={pay2} alt="payment" /></a>
            <a href="#"><img src={pay3} alt="payment" /></a>
            <a href="#"><img src={pay4} alt="payment" /></a>
          </div>
