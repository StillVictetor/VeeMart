...
const ContactHome = () => {
    ...
    const IMAGES = [
        {id: 1, src: banner, alt: "Banner 1", name: "CONTACT"  },
    ]
...
<div className='contact'>
        ...
        <div className='contact-details'>
            <div>
                ...
                <p> <LocateFixedIcon color='#333' className='icons' size={20}/> Unicus, PTI, ||| Warri, Delta State</p>
                
                <p> <PhoneIcon color='#333' className='icons' size={20}/> +234 7035731997 ||| +234 9011789933</p>
                <p> <MailIcon color='#333' className='icons' size={20}/> veemart@gmail.com ||| victetor.dev@gamil.com</p>
            </div>
            ...
            <form  className='send-message'>
                ...
                <textarea name="Message" id="message" placeholder='Message' rows={5} cols={40}  ></textarea>
